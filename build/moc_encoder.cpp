...
QT_MOC_LITERAL(3, 23, 7), // "new_pos"
QT_MOC_LITERAL(4, 31, 16) // "on_timer_timeout"

    },
    "Encoder\0value_changed\0\0new_pos\0"
    "on_timer_timeout"
};
...
void Encoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->value_changed((*reinterpret_cast< double(*)>(_a[1]))); break;
        ...
        {
            typedef void (Encoder::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Encoder::value_changed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Encoder::value_changed(double _t1)
{
