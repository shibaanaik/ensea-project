...
#include "../QSimpleRestServer/src/http/qhttpconnection.h"
...
void QHttpConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHttpConnection::allBytesWritten)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject QHttpConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QHttpConnection.data,
      qt_meta_data_QHttpConnection,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
